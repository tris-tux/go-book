...
type Repo interface {
	...
	Update(book schema.Book) (schema.Book, error)
	Delete(book schema.Book) (schema.Book, error)
}
...
func (r *repo) Update(book schema.Book) (schema.Book, error) {
	err := r.db.Save(&book).Error

	return book, err
}

func (r *repo) Delete(book schema.Book) (schema.Book, error) {
